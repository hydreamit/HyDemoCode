...
- (id<HyNetworkSingleTaskProtocol>)requestType:(HyNetworRequestType)type
    ...
    id<HyNetworkSingleTaskProtocol> task = [AFNetworkSingleTask taskWithNetwork:self taskInfo:signleTask];
...
- (id<HyNetworkMutipleTasksProtocol>)requestShowHUD:(BOOL)showHUD
    ...
    id<HyNetworkMutipleTasksProtocol> task = [HyNetworkMutipleTasks taskWithNetwork:self taskInfo:info];
